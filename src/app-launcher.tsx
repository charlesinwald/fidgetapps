          ...
          <div className="grid grid-cols-2 gap-8 w-full h-full p-8">
            {apps.map((app) => {
              ...
              const renderIcon = () => {
                ...
                // Fallback icon
                return (
                  <div className={`w-40 h-40 ${app.iconColor} flex items-center justify-center text-6xl font-bold rounded-xl transition-all duration-300 ${
                    isOpening ? "scale-110" : ""
                  }`}>
                    ?
                  </div>
          ...
          <div className="relative">
            {(() => {
              ...
              const renderPreviewIcon = () => {
                ...
                return (
                  <div className={`w-16 h-16 ${app.iconColor} flex items-center justify-center text-2xl font-bold rounded-lg`}>
                    ?
                  </div>
                );
              };
